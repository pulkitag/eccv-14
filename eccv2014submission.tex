...
\hline\noalign{\smallskip}
layer & unroll & sp-shuffle & sp-max & bin & max-bin-loc & max-loc\\
\noalign{\smallskip}
\hline
\noalign{\smallskip}
pool-1 & 25.1 & 15.0 & 19.5 & 25.4 & 10.0 & 9.0\\
pool-2 & 44.9 & 33.5 & 40.2 & 43.0 & 24.2 & -\\
conv-3 & 50.1 & 40.4 & 54.2 & 47.0 & 28.5 & -\\
conv-4 & 54.2 & 45.3 & 57.0 & 51.3 & 33.5 & -\\
pool-5 & 65.6 & 59.6 & 62.6 & 60.5 & 40.6 & 45.0\\
relu-6 & 70.6 &  -   &  -   & 71.4 &  -   & - \\
relu-7 & 73.6 &  -   &  -   & 74.1 &  -   & - \\
\hline
\end{tabular}
...
It is also notable that these different ablations have different effects on different layers. For example, where as spatial-max is brutal for layer-1 it doesnot really effect classification is layer 5 features are used. On the other hand while binarization has little effect on layer-1 features it results into a drop of performance for layer-5. 
...
max-bin-loc & 49.1 & 48.0 & 19.0 & 15.2 & 12.9 & 44.7 & 57.0 & 32.8 & 11.9 & 32.5 & 19.0 & 25.0 & 37.5 & 41.6 & 34.8 & 15.6 & 34.1 & 13.0 & 35.7 & 44.9 & 31.2 \\
...
\subsection{Discussion}
Our experiments indicate that if the goal is classification layer 5 features can be simply treated as bag of filters without much loss in performance. On the other hand, binarizing layer 5 features doesnot hurt detection performance. We also find that different ablations have affect different layers in different ways. This is a good thing to know when designing systems which use features from multiple layers.
