...
\begin{table}[t!]
\begin{center}
\caption{Comparing the performance of CNNs trained from scratch, pre-trained on ImageNet, and fine-tuned. PASCAL-DET+DATA includes additional data from VOC 2012 trainval. (Bounding-box regression is not used for detection results.)}
\vspace{0.3em}
...
These results can be compared to the 30.5\% mAP obtained by DetectorNet \cite{szegedy2013deep}, which was trained from scratch on VOC 2012 trainval.
