...
Figure \ref{fig:fine-entropy} shows that MCAuE decreases from layers 1 to 7 for both the networks, which means that individual filters grow more discriminative from layers 1 to 7.
