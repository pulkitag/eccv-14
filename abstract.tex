\begin{abstract}
Over the last two years, convolutional neural networks (CNN) have achieved an impressive suite of results on standard recognition datasets and tasks.
CNN-based features seem poised to quickly replace engineered representations, such as SIFT and HOG, over the next few years.
